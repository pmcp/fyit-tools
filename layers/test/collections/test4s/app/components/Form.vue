...
import type { Test4FormProps, Test4FormData } from '../../types'
import { z } from 'zod'

const { send } = useCrud()

const props = defineProps<Test4FormProps>()

const { defaultValue, schema } = useTest4s()

// Create a reactive form state with proper typing
const state = reactive<Test4FormData & { id?: string | null }>({
  id: null,
  name: '',
  description: ''
})
